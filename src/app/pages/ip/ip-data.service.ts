...
export class IpDataService {
  ...
  private readonly apiKey: string = 'UwGCO4DZPD66kaS7nsXoC8mZEeeGP9AKjDgJGNOkREjmj3cMOO';
  ...
  private readonly apiTimeZoneUrl: string = 'https://api.timezonedb.com/v2.1/get-time-zone';
  ...
  getWeatherByLatAndLon = (lat: number, lon: number): Observable<IpWeather> =>
     this.http.get<IpWeather>(`${this.apiWeatherUrl}lat=${lat}&lon=${lon}&appid=${this.apiWeatherKey}&units=metric`);
